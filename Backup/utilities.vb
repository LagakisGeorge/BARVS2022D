...
Public Class utilities
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '================================ PRODUCT_ATTRIBUTES ================================
        ExecuteSQLQuery("SELECT COUNT(*) AS N FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' AND TABLE_NAME  = 'TABLEFIELDS'", SQLDT)
        ...
        If sqlDT(0)(0) = 0 Then
            ExecuteSQLQuery("CREATE TABLE TABLEFIELDS ( " & _
                            ...
                            ",COMBOQUERY VARCHAR(100) NULL )", SQLDT)
        ...
        If ANS = vbYes Then
            ExecuteSQLQuery("DELETE FROM TABLEFIELDS", SQLDT)
            UPDATE_TABLE("PEL")
            UPDATE_TABLE("EID")
            UPDATE_TABLE("TIM")
            UPDATE_TABLE("GRA")
    ...
    Sub UPDATE_TABLE(ByVal PINAKAS As String)
        ...
        For K = 0 To DT.Columns.Count - 1
            ExecuteSQLQuery("INSERT INTO TABLEFIELDS (TABLENAME,FIELDNAME) VALUES" & _
                             "( '" + PINAKAS + "','" + DT.Columns(K).Caption + "')", SQLDT)
        Next
        DT = Nothing
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '================================ PRODUCT_ATTRIBUTES ================================
        ExecuteSQLQuery("SELECT COUNT(*) AS N FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' AND TABLE_NAME  = 'NEWMENUS'", SQLDT)
        ...
        If sqlDT(0)(0) = 1 Then
            ExecuteSQLQuery("DROP TABLE NEWMENUS", SQLDT)
        End If
       ...
       ",[MENUNAME] VARCHAR(200) NULL) ", SQLDT)
    ...
    Public Sub paint_ergasies(ByVal sql As String)
        ...
        Dim cnString As String = gCONNECT
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        ExecuteSQLQuery(TextBox1.Text, SQLDT)
    ...
    Private Sub SQL_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SQL.Click
        ...
        Try
            ...
            sqlCon = New SqlConnection(gCONNECT)

            Dim sqlDA As New SqlDataAdapter(TextBox1.Text, sqlCon)
...
110:    ExecuteSQLQuery("BACKUP DATABASE [TECHNOPLASTIKI] TO  DISK ='" + C + "' WITH NOFORMAT, NOINIT, SKIP, NOREWIND, NOUNLOAD,  STATS = 10", SQLDT)
